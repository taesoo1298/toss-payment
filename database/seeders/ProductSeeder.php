    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'volume' => '120g',
                'features' => json_encode(['미백', '불소함유', '저자극']),
                'target_audience' => json_encode(['성인']),
                'rating' => 4.7,
                'review_count' => 892,
                'stock' => 500,
                'sold_count' => 3421,
            ...
            [
                ...
                'volume' => '120g',
                'features' => json_encode(['강력미백', '불소함유', '민트향']),
                'target_audience' => json_encode(['성인']),
                'rating' => 4.5,
                'review_count' => 543,
                'stock' => 300,
            ...
            [
                ...
                'volume' => '120g',
                'features' => json_encode(['잇몸강화', '출혈예방', '한방성분']),
                'target_audience' => json_encode(['성인', '노인']),
                'rating' => 4.6,
                'review_count' => 567,
                'stock' => 300,
                'sold_count' => 1987,
            ...
            [
                ...
                'volume' => '120g',
                'features' => json_encode(['민감완화', '저자극', '무연마제']),
                'target_audience' => json_encode(['성인']),
                'rating' => 4.7,
                'review_count' => 432,
                'stock' => 250,
            ...
            [
                ...
                'volume' => '80g',
                'features' => json_encode(['불소함유', '딸기향', '저불소']),
                'target_audience' => json_encode(['어린이']),
                'rating' => 4.8,
                'review_count' => 721,
                'stock' => 400,
                'sold_count' => 2876,
            ...
            [
                ...
                'efficacy' => '충치 예방, 치아 강화',
                'volume' => '80g',
                'features' => json_encode(['불소함유', '포도향', '저불소']),
                'target_audience' => json_encode(['어린이']),
                'rating' => 4.7,
                'review_count' => 489,
                'stock' => 350,
            ...
            [
                ...
                'volume' => '120g',
                'features' => json_encode(['한방성분', '천연', '녹차추출물']),
                'target_audience' => json_encode(['성인']),
                'rating' => 4.5,
                'review_count' => 378,
                'stock' => 220,
            ...
            [
                ...
                'volume' => '120g',
                'features' => json_encode(['올인원', '미백', '잇몸케어', '충치예방']),
                'target_audience' => json_encode(['성인']),
                'rating' => 4.6,
                'review_count' => 654,
                'stock' => 450,
            ...
            [
                ...
                'volume' => '120g',
                'features' => json_encode(['프리미엄', '올인원', '미백', '잇몸케어']),
                'target_audience' => json_encode(['성인']),
                'rating' => 4.8,
                'review_count' => 432,
                'stock' => 200,
            ...
            [
                ...
                'volume' => '120g',
                'features' => json_encode(['저자극', '민감완화', '올인원']),
                'target_audience' => json_encode(['성인']),
                'rating' => 4.6,
                'review_count' => 298,
                'stock' => 180,
